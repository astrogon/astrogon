...
Das Link Redirect System ermöglicht es dir, Links zentral zu verwalten, Klicks zu tracken und bei Affiliate-Links automatisch Compliance-konforme Weiterleitungen mit Disclosure zu erstellen. **Das System ist vollständig GitHub Pages kompatibel** und funktioniert ohne Server-Side Rendering.
...
**Hinweis:** Markdown-Links und direkte href-Links funktionieren nicht mehr, da das System jetzt client-side JavaScript erfordert.
